...
const columnsInCompany = [
  ...
  {
    Header: 'Status',
    accessor: d => {return d.quoteType=='quote'?d.currentstatus:d.status.name=="customerAcceptEndorsement"?"Accepted":d.status.name=="customerRejectEndorsement"?'Rejected':''},
  },
];

export default columnsInCompany;
