...
run `npm run lint` to see the lint issues

for any reference related to lint issue check the docs link below

[https://eslint.org/docs/user-guide/getting-started]

commitlint is used to validate the message that we use to commit

[https://github.com/conventional-changelog/commitlint]

Install the extension EditorConfig for VS Code. This is for setting the End of Line Sequence to LF
in .editorconfig.
